...
import { matchSchoolBrand } from "./branding";
import type { PreviewLockerRow } from "./types";

// Read reference branding; never create or change an athlete affiliation here.
export async function enrichPreviewSchoolBranding(client: SupabaseClient, row: PreviewLockerRow): Promise<PreviewLockerRow> {
